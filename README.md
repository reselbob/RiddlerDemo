...
## Overview
This a sample NodeJS server application created to demonstrate how to use the Swagger specfication to defined and publish an API along with the documentation that is necessary for its use.
